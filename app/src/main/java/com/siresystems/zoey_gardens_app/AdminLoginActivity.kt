            ...
            ApiClient.instance.adminlogin(userPhone, userPass)
                .enqueue(object : Callback<UserResponse> {
                    ...
                    override fun onResponse(call: Call<UserResponse>, response: Response<UserResponse>) {
                        ...
                        if (response.isSuccessful && response.body() != null) {
                            ...
                            if (res.status == "success") {
                                ...
                                Toast.makeText(this@AdminLoginActivity, "Welcome ${res.name}", Toast.LENGTH_SHORT).show()

                                startActivity(Intent(this@AdminLoginActivity, AdminDashboardActivity::class.java))
                                finish()

                            } else {
                                Toast.makeText(this@AdminLoginActivity, res.message ?: "Login failed", Toast.LENGTH_SHORT).show()
                            }

                        } else {
                            Toast.makeText(this@AdminLoginActivity, "Server error", Toast.LENGTH_SHORT).show()
                        }
                    }
                    ...
                    override fun onFailure(call: Call<UserResponse>, t: Throwable) {
                        ...
                        Toast.makeText(this@AdminLoginActivity, "Network error: ${t.message}", Toast.LENGTH_SHORT).show()
                    }
                })
        }
    }
